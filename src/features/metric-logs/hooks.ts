...
import {
  ...
  updateMetricLog,
} from "@/src/features/metric-logs/api";
import type {
 ...
 */
const useMetricLogListOffset = (metricId: string, page: number, limit: number = 20) => {
...
export function useMetricLogListCursorPagniation(params: {
  limit: number;
  sort: MetricLogSortViaCursor;
  q?: string;
  filter?: MetricLogFilterViaCursor;
...
export {
  ...
  useDeleteMetricLog,
  useMetricLogListOffset as useMetricLogs,
  useUpdateMetricLog,
};
