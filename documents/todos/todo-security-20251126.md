...
## Notes
- Revisit `documents/security/control-matrix.md` after each future change to keep control status accurate.
- Capture verification evidence in `documents/security/security-audit-log.md` for each sprint.
