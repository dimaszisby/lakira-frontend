...
| Layer 3 Integration | `documents/tests-plans-and-logs/3-integration-tests/PLAN.md`, `documents/tests-plans-and-logs/3-integration-tests/CHECKLIST.md`, `documents/tests-plans-and-logs/3-integration-tests/a11y-testing-checklist.md` | `Gated` | Medium-High | Boundary hardened via dedicated integration runner (`jest.integration.config.ts`); baseline now covers auth login/register, metric-category/metric/metric-log/metric-settings forms, metric-categories/metrics/logs list states, dashboard loading/success/empty/error states, metric-detail composite navigation/section rendering states, and shared navigation-shell behavior (bottom navigation + sidebar + app layout). `jest-axe` assertions are active on login/register, metric-category/log/settings forms, metric-categories/metrics/logs pages, dashboard, metric-detail composite, bottom navigation, sidebar, and layout baselines. | Keep integration runtime stable and expand remaining shell/layout-state scenarios as coverage depth improvements. |
...
| Cross-cutting A11y (Integration + E2E) | `documents/tests-plans-and-logs/3-integration-tests/a11y-testing-checklist.md`, `documents/tests-plans-and-logs/4-end-to-end-tests/a11y-e2e-checklist.md`, `documents/documentation/accessibility-guidelines.md` | `Partial` | Medium | Integration-level `jest-axe` assertions are now active on login/register, metric-category/log/settings forms, metric-categories/metrics/logs pages, dashboard, metric-detail composite, bottom navigation, sidebar, and layout baselines; E2E a11y checks are still pending. | Decide E2E a11y gate scope and implement first authenticated flow checks. |
