...
| Cross-cutting A11y (Integration + E2E) | `documents/tests-plans-and-logs/3-integration-tests/a11y-testing-checklist.md`, `documents/tests-plans-and-logs/4-end-to-end-tests/a11y-e2e-checklist.md`, `documents/documentation/accessibility-guidelines.md` | `Partial` | Medium | Integration-level `jest-axe` assertions are now active on login/register, metric-category/log/settings forms, metric-categories detail/list/logs pages, dashboard, metric-detail composite, bottom navigation, sidebar, and layout baselines; E2E a11y checks are still pending. | Decide E2E a11y gate scope and implement first authenticated flow checks. |
