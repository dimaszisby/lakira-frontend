...
- Automated checks:
  - [Lighthouse Plan](../tests-plans-and-logs/5-performance-and-web-vitals-tests/lighthouse-plan.md)
  - [Web Vitals Plan](../tests-plans-and-logs/5-performance-and-web-vitals-tests/web-vitals-plan.md)
  - [Bundle Size Checklist](../tests-plans-and-logs/5-performance-and-web-vitals-tests/bundle-size-checklist.md)
- Release gates:
...
From real-user telemetry (see [Web Vitals Plan](../tests-plans-and-logs/5-performance-and-web-vitals-tests/web-vitals-plan.md)):
