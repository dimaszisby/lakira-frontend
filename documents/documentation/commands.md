...
| Command                      | What it does                                                                 |
| ---------------------------- | ---------------------------------------------------------------------------- |
| `npm run api:spec:sync`      | Refetch `documents/openapi/lakira-backend-openapi.json` from lakira-backend. |
...
- `documents/openapi/lakira-backend-openapi.json` → `npm run api:spec:sync`
