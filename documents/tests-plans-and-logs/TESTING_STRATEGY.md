...
[Accessibility Guidelines](../documentation/accessibility-guidelines.md), and are enforced
via integration and E2E tests plus release checklists.

Performance budgets and expectations are defined in the
[Performance Budget](../documentation/performance-budget.md) document and are enforced
...
- **Security**: detailed in `/documents/security-audit/*`, referenced by release checklists.
- **Release readiness**: high-level checklists in `/documents/checklists/*`.
...
- `documents/tests-plans-and-logs/1-static-checks/CHECKLIST.md`
...
- [A11y Release Checklist](../checklists/a11y-release-checklist.md)
...
- **OpenAPI-driven types** (in `/documents/openapi/*.ts`).
...
- Release-time checklists:
  - `documents/checklists/release-checklist.md`
  - `documents/todos/*` for time-boxed security tasks.
