...
## Next Steps
1. Expand this baseline into a detailed threat model (`docs/internal/audits/security/audit-2025-11-21/threat-model.md`) describing assets, trust boundaries, and abuse cases specific to Metrics, Metric Categories, and Log flows.
