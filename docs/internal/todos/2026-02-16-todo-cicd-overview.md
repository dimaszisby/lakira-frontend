...
| --- | --- | --- | --- | --- | --- |
| Layer 1 Static Checks | `docs/explanation/testing-strategy.md`, `docs/internal/initiatives/tests-overhaul/1-static-checks/CHECKLIST.md` | `Gated` | Medium-High | Checklist restored; warning cleanup stream is still open for long-term quality. | Keep static-check execution log current after each CI/pipeline policy change. |
| Layer 2 Unit | `docs/internal/initiatives/tests-overhaul/2-unit-tests/PLAN.md`, `docs/internal/initiatives/tests-overhaul/2-unit-tests/CHECKLIST.md` | `Gated` | Medium-High | Boundary hardened via dedicated unit runner (`jest.unit.config.ts`); checklist/run-log refresh still needed for latest evidence. | Keep unit coverage progression and refresh evidence logs after each batch. |
| Layer 3 Integration | `docs/internal/initiatives/tests-overhaul/3-integration-tests/PLAN.md`, `docs/internal/initiatives/tests-overhaul/3-integration-tests/CHECKLIST.md`, `docs/internal/initiatives/tests-overhaul/3-integration-tests/a11y-testing-checklist.md` | `Gated` | Medium-High | Boundary hardened via dedicated integration runner (`jest.integration.config.ts`); baseline now covers auth login/register, metric-category/metric/metric-log/metric-settings forms, metric-categories detail/list/logs states, dashboard loading/success/empty/error states, metric-detail composite navigation/section rendering states, and shared navigation-shell behavior (bottom navigation + sidebar + app layout). `jest-axe` assertions are active on login/register, metric-category/log/settings forms, metric-categories detail/list/logs pages, dashboard, metric-detail composite, bottom navigation, sidebar, and layout baselines. | Keep integration runtime stable and expand remaining shell/layout-state scenarios as coverage depth improvements. |
| Layer 4 E2E | `docs/internal/initiatives/tests-overhaul/4-end-to-end-tests/PLAN.md`, `docs/internal/initiatives/tests-overhaul/4-end-to-end-tests/CHECKLIST.md`, `docs/internal/initiatives/tests-overhaul/4-end-to-end-tests/a11y-e2e-checklist.md` | `Partial` | Medium-High | Base URL and auth/token helper scaffolding are implemented; broader authenticated flows and reset hooks remain pending. | Expand from smoke to authenticated metric/category/log/settings coverage. |
| Layer 5 Performance / Web Vitals | `docs/internal/initiatives/tests-overhaul/5-performance-and-web-vitals-tests/lighthouse-plan.md`, `docs/internal/initiatives/tests-overhaul/5-performance-and-web-vitals-tests/web-vitals-plan.md`, `docs/internal/initiatives/tests-overhaul/5-performance-and-web-vitals-tests/bundle-size-checklist.md` | `Partial` | Medium | Scripts/config and scheduled CI are wired, but real-user Web Vitals instrumentation is still pending. | Keep scheduled audits stable and implement RUM Web Vitals collection path. |
| Cross-cutting A11y (Integration + E2E) | `docs/internal/initiatives/tests-overhaul/3-integration-tests/a11y-testing-checklist.md`, `docs/internal/initiatives/tests-overhaul/4-end-to-end-tests/a11y-e2e-checklist.md`, `docs/reference/accessibility-baseline.md` | `Partial` | Medium | Integration-level `jest-axe` assertions are now active on login/register, metric-category/log/settings forms, metric-categories detail/list/logs pages, dashboard, metric-detail composite, bottom navigation, sidebar, and layout baselines; E2E a11y checks are still pending. | Decide E2E a11y gate scope and implement first authenticated flow checks. |
...
- [x] Layer 1: define/restore static-checks checklist artifact in `docs/internal/initiatives/tests-overhaul/1-static-checks/CHECKLIST.md`.
...
- [x] Track typo/path cleanup for the `3-integration-tests` checklist naming consistency (canonical `CHECKLIST.md` added; the legacy `CHEKLIST.md` compatibility pointer was removed in the 2026-08-22 Diátaxis overhaul).
- [ ] Keep overview lean and link out to detail docs (single-source principle from `docs/explanation/documentation-standards.md`).
...
- `docs/internal/initiatives/tests-overhaul/5-performance-and-web-vitals-tests/lighthouse-plan.md`
- `docs/internal/initiatives/tests-overhaul/5-performance-and-web-vitals-tests/web-vitals-plan.md`
