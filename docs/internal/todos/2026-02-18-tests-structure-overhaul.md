...
- [x] Update `docs/explanation/testing-strategy.md`.
- [x] Update `docs/reference/components/component-testing-and-quality-gates.md`.
- [x] Update `docs/internal/initiatives/cicd/README.md`.
- [x] Update `docs/internal/initiatives/cicd/pipeline-plan.md`.
- [x] Update `docs/internal/todos/2026-02-16-todo-cicd-overview.md`.
