...
- Track the initiative under `docs/internal/initiatives/components-overhaul/`.
...
1. Put all content under `docs/reference/components/`
2. Use `docs/internal/initiatives/components-overhaul/` and cross-link to standards docs

Consequences:

- Standards remain stable in `docs/reference/components/`.
...
> **Promoted to [ADR-0001](../../../explanation/decisions/adr-0001-button-consolidation-and-primarybutton-deprecation-window.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0002](../../../explanation/decisions/adr-0002-immediate-primarybutton-removal.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0003](../../../explanation/decisions/adr-0003-standardize-on-formfield-and-remove-fieldshell.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0004](../../../explanation/decisions/adr-0004-colorfield-tokenization-and-hex-contract.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0005](../../../explanation/decisions/adr-0005-pagination-contract-and-accessibility-guardrails.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0006](../../../explanation/decisions/adr-0006-card-primitive-contract.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0007](../../../explanation/decisions/adr-0007-table-contract-and-row-interaction-guardrails.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0008](../../../explanation/decisions/adr-0008-visualization-url-state-sync.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0009](../../../explanation/decisions/adr-0009-select-listbox-trigger-semantics.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0010](../../../explanation/decisions/adr-0010-modal-focus-management-and-close-behaviour.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0011](../../../explanation/decisions/adr-0011-sort-controls-and-skeleton-naming.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0012](../../../explanation/decisions/adr-0012-closure-gates-and-the-tier-test-minimum.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0013](../../../explanation/decisions/adr-0013-visualization-url-driven-state-source.md)** in the flat registry. That record is the durable copy; this entry is the original log.
...
> **Promoted to [ADR-0014](../../../explanation/decisions/adr-0014-modal-shared-scroll-lock-coordination.md)** in the flat registry. That record is the durable copy; this entry is the original log.
